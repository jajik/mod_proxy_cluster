...
{
    static const char *const asz_pre[] = {"mod_manager.c", "mod_rewrite.c", "mod_slotmem.c", NULL};
    ...
    ap_hook_child_init(proxy_cluster_child_init, asz_pre, NULL, APR_HOOK_LAST);
    ...
    ap_hook_translate_name(proxy_cluster_trans, asz_pre, asz_succ, APR_HOOK_FIRST);
